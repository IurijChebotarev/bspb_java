package ru.bspb.lessonSix;

import ru.bspb.lessonSix.objects.Fiz;
import java.util.Set;
import java.util.TreeSet;
import static ru.bspb.lessonSix.enums.Sex.FEMALE;
import static ru.bspb.lessonSix.enums.Sex.MALE;
import static ru.bspb.lessonSix.utilities.Utillities.*;
